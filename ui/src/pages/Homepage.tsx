		...
		<>
			...
			<div className="container">
				...
				<table className="homepage__buttons">
					<tr>
						<div className="homepage__buttons__div c1_1" onClick={() => {window.location.href = '/drivers'}}>
							<img src="./assets/drivers_button.png" alt="CASELLA 1" />
								
							<div className="text-overlay">DRIVERS</div>
						</div>

						<div className="homepage__buttons__div c2_1" onClick={() => {window.location.href = '/races'}}>
					...
					<tr className="prova">
						<div className="homepage__buttons__div c1_2" onClick={() => {window.location.href = '/circuits'}}>
							<img src="./assets/circuits_button.png" alt="Circuits" />
							<div className="text-overlay">CIRCUITS</div>
						</div>

						<div className="homepage__buttons__div c2_2" onClick={() => {window.location.href = '/hof'}}>
